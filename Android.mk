...
include $(CLEAR_VARS)
LOCAL_MODULE := HotwordEnrollmentOKGoogleHALO
LOCAL_MODULE_OWNER := motorola
LOCAL_SRC_FILES := proprietary/priv-app/HotwordEnrollmentOKGoogleHALO/HotwordEnrollmentOKGoogleHALO.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := HotwordEnrollmentXGoogleHALO
LOCAL_MODULE_OWNER := motorola
LOCAL_SRC_FILES := proprietary/priv-app/HotwordEnrollmentXGoogleHALO/HotwordEnrollmentXGoogleHALO.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
